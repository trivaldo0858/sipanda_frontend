...
class _DetailAnakScreenState extends State<DetailAnakScreen> {
            ...
            return Center(
              child: Column(
                ...
                children: [
                  ...
                  ElevatedButton(
                    onPressed: () => provider.loadAnakDetail(widget.nikAnak),
          ...
          return SingleChildScrollView(
            ...
            child: Column(
              children: [
                ...
                _buildInfoCard(anak),
                const SizedBox(height: 16),
                _buildAksiCard(context, anak, isKader),
              ],
            ),
          );
        },
  ...
  Widget _buildHeaderCard(AnakModel anak) {
    final color   = anak.isLakiLaki ? _primary : const Color(0xFFE91E63);
    final bgColor = anak.isLakiLaki ? const Color(0xFFEAF2FF) : const Color(0xFFFCE4EC);
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          Text(anak.nikAnak, style: const TextStyle(fontSize: 13, color: _textGrey)),
          const SizedBox(height: 12),
          Row(
            mainAxisAlignment: MainAxisAlignment.center,
            children: [
              _buildBadge(anak.jenisKelaminLabel, color, bgColor),
              if (anak.umurFormat != null) ...[
                const SizedBox(width: 8),
                _buildBadge(anak.umurFormat!, const Color(0xFF198754), const Color(0xFFD1E7DD)),
              ],
            ],
          ),
        ],
  ...
  Widget _buildAksiCard(BuildContext context, AnakModel anak, bool isKader) {
    return Column(
      children: [
        // Grafik KMS — semua role
        _buildAksiButton(
        ...
        if (isKader) ...[
          ...
          _buildAksiButton(
            ...
            onTap: () => context.push('/pemeriksaan/catat?nik_anak=${anak.nikAnak}'),
          ),
          const SizedBox(height: 10),
          _buildAksiButton(
